...
export default function ProfileLayout({children}: {children: React.ReactNode}) {
  ...
  return (
    <main className="flex flex-col pt-4 lg:pt-10 pl-2 lg:pl-4 lg:flex-row lg:gap-[60px] xl:w-[80%] mx-auto h-[calc(100vh-64px)] xl:h-[calc(100vh-102px)] overflow-hidden">
